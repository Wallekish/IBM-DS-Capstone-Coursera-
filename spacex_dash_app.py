...
def get_pie_chart(entered_site):
    if entered_site == 'All Sites':
        ...
        names='Launch Site', 
        title='Successful Launches by All Sites')
        return fig
    else:
...
def get_scatter_plot(entered_site, slide):
    if entered_site == 'All Sites':
        ...
        title = 'Successful Launches by Payload for All Sites')
        return fig
    else:
        low, high = slide
        df = spacex_df[spacex_df['Launch Site']== entered_site][spacex_df['Payload Mass (kg)'].between(min_payload, max_payload)]
        fig = px.scatter(df, x='Payload Mass (kg)', y='class', color='Booster Version Category',
        title = 'Successful Launches by Payload for '+entered_site)
        return fig
